...
public class Pass1 {
    public static void main(String args[]) throws NullPointerException, FileNotFoundException {
        ...
        try {
                    ...
                    switch (tokens[k]) {
                        ...
                        case "origin":
                            ...
                            if (pos != -1) {
                                ...
                                System.out.println("Error: Symbol not found in ORIGIN: " + tokens[k]);
                            }
                            break;
                        ...
                        case "ltorg":
                            ...
                            if (pooltab_cnt == 0)
                                ...
                                pooltab[pooltab_cnt] = new Pooltable(
                                        pooltab[pooltab_cnt - 1].first + pooltab[pooltab_cnt - 1].total_literals,
                                        total_ltr - pooltab[pooltab_cnt - 1].first - 1);
                                pooltab_cnt++;
                            }
                            break;
                        ...
                        case "equ":
                            ...
                            if (pos1 != -1 && pos != -1) {
                                ...
                                System.out.println("Error: Symbol not found in EQU statement");
                            }
                            loc--;
                            break;
                    }
                    ...
                    if (pos == -1) {
                        ...
                        if (pos != -1) {
                            ...
                            if (pos != -1) {
                                ...
                                pos = search(tokens[k], symb_table, total_symb);
                                if (pos == -1) {
                                    symb_table[total_symb++] = new Obj(
                                            tokens[k].substring(0, tokens[k].length() - 1),
                                            loc - 1);
                        ...
                        if (pos != -1)
                            ...
                            if (tokens[k].matches("='\\d+'")) {
                                ...
                                bw.write("\t(L," + total_ltr + ")");
                                    ...
                                    || tokens[k].matches("\\d+h") || tokens[k].matches("\\d+D")
                                    || tokens[k].matches("\\d+d")) {
                                bw.write("\t(C," + tokens[k] + ")");
            ...
            pooltab[pooltab_cnt] = new Pooltable(
                    pooltab[pooltab_cnt - 1].first + pooltab[pooltab_cnt - 1].total_literals,
                    total_ltr - pooltab[pooltab_cnt - 1].first - 2);
            pooltab_cnt++;
